    ...
    return input.chunks.flatMap((chunk) => {
      ...
      if (chunk.text.includes("Declared total is 100 units")) {
        rows.push({
          ...
          usage: "answer_core",
          classificationRationale: "Test row is a declared total quoted from the source.",
      ...
      if (chunk.text.includes("Source A contributes 40 units")) {
        rows.push({
          ...
          authority: "documentary_record",
          usage: "answer_core",
          classificationRationale: "Test row is an itemized value quoted from the source.",
          evidenceChunkId: chunk.id,
