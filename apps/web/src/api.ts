...
export const api = {
  ...
  libraryAori: (libraryId: string) => request<LibraryAoriResponse>(`/libraries/${libraryId}/aori`),
  libraryAoriGraph: (libraryId: string, view: AoriGraphViewMode = "layer") =>
    request<AoriGraphView>(`/libraries/${libraryId}/aori/graph?view=${view}`),
  libraryAoriMergePlans: (libraryId: string) => request<LibraryMergePlan[]>(`/libraries/${libraryId}/aori/merge-plans`),
  runLibraryAoriMerge: (libraryId: string) => request<LibraryAoriResponse>(`/libraries/${libraryId}/aori/merge`, { method: "POST" }),
